 ...
 */
export function getListOfWagons(...all) {
  return all;
} 
...
export function correctListOfWagons(ids, missingWagons) {
  const [one, ...others] = ids;
  let newAll = [one, ...missingWagons, ...others];
  return newAll;
}
 ...
 */
export function separateTimeOfArrival(obj) {
 const { timeOfArrival , ...rest } = obj;
