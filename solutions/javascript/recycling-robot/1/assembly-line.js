...
export function isNumericString(value) {
  return typeof value === "string" && value.trim() !== "" && !Number.isNaN(Number(value)) && Number.isFinite(Number(value));
}
...
export function assertHasId(object) {
  if (!(object != null && ("id" in object))) throw new Error('Object is missing "id" property');
}
...
export function hasIdProperty(object) {
  return object != null && Object.prototype.hasOwnProperty.call(object, "id");
}
...
export function hasDefinedType(object) {
  return object != null && Object.prototype.hasOwnProperty.call(object, "type") && object.type !== undefined;
}
